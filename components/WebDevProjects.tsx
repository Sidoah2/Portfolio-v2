    ...
    return (
        <Section id="web-dev">
            <h2 className="text-4xl font-bold mb-16 text-center">
                Web <span className="text-gradient">Development</span> Projects
            </h2>
                        ...
                        <div className="relative p-8 md:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-2 mb-6">
                                {project.tech.map((t, i) => (
                                    <span key={i} className="text-xs bg-white/5 border border-white/10 px-2 py-1 rounded text-primary">
                                        {t}
                                    </span>
                                ))}
                            </div>
